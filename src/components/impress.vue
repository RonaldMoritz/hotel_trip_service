<template>
  <div class="page-heading-container">
    <h2 class="sub-heading page-heading">Impressum</h2>
  </div>

  <div class="impress">
    <p>Dieser Webservice ist eine Gruppenarbeit im Rahmen der Lehrveranstaltung "Service Engineering" an der Johannes
      Kepler Universität Linz zur Verwaltung von Tagesausflügen für Hotelgäste.</p>
    <p>Team 07: Moritz Ronald, Nally Maria, Schießl Christian</p>
  </div>
  ...
  <div>
    ...
    <p>Geschäftsführer: Marco Stadler<br>Marco Stadler Webdesigns<br>Magnus-Huber-Str. 3<br>94148 Kirchham</p>
    <p>E-Mail: info@marco-stadler.com</p>
